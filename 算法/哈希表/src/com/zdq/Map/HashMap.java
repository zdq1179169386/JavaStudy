...
public class HashMap<K,V> implements Map<K,V> {
    ...
    private static final int DEFAULR_CAPACITY = 1 << 4;//起始容量
    private static final float DEFAULT_LOAD_FACTOR = 0.75f;//扩容因子

    public HashMap() {
        table = new Node[DEFAULR_CAPACITY];
    }
...
//        fixAfterPut(newNode);
    ...
    //比较
    private int compare(K e1, K e2,int h1, int h2) {
        //比较哈希值
        int result = h1 - h2;
        if (result != 0) {
            return result;
        ...
        //比较类名
        if (e1 != null && e2!= null){
            String k1Cls = e1.getClass().getName();
            String k2Cls = e2.getClass().getName();
